...
public class AccountServiceController {
	    ...
	    public AccountServiceModel addAccount(@RequestBody Map<String, String> body){
	        String name = body.get("name");
	        String email = body.get("email");
	        String password = body.get("password");
	        return accountServiceRepository.save(new AccountServiceModel(name, email, password));
	    }
